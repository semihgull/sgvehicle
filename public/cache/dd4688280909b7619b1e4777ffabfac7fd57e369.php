...
<?php $__env->startSection('title', 'Usta Kayıt Düzenleme'); ?>

<?php $__env->startSection('content'); ?>

            <div class="page-heading">
                <h3>Usta Kayıt Düzenleme</h3>
            </div>
            <?php if(@$_COOKIE['msg']): ?>
                <script>
                    Swal.fire('<?php echo e($_COOKIE['msg']); ?>')
                </script>
            <?php endif; ?>
            <?php if(@$type == 'success'): ?>
                <script>userRedirect('<?php echo e(site_url('master/on-hold-order')); ?>', 1)</script>
            <?php endif; ?>
            <div class="page-content">
                <section class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo e(site_url('master/order/detail/update')); ?>" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="related-master-edit" name="related-master-edit" disabled value="<?php echo e(auth()->getFullname()); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="customer-id-edit">Müşteri Adı</label>
                                                            <input type="text" class="form-control" id="customer-id-edit" name="customer-id-edit" disabled
                                                                   value="<?php echo e(\App\Services\VehicleInfoServices::ShowCar($orders['car-id'], 'owner')); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
<?php $__env->startSection('js'); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('../layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgboilerplate\public\views/master/detail-order.blade.php ENDPATH**/ ?>