...
@section('title', 'Usta Kayıt Düzenleme')
...
@section('content')
            ...
            @if(@$_COOKIE['msg'])
                <script>
                    Swal.fire('{{$_COOKIE['msg']}}')
                </script>
            @endif
            @if(@$type == 'success')
                <script>userRedirect('{{site_url('master/on-hold-order')}}', 1)</script>
            @endif
            <div class="page-content">
                <section class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{site_url('master/order/detail/update')}}" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="related-master-edit" name="related-master-edit" disabled value="{{auth()->getFullname()}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="customer-id-edit" name="customer-id-edit" disabled
                                                                   value="{{\App\Services\VehicleInfoServices::ShowCar($orders['car-id'], 'owner')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
