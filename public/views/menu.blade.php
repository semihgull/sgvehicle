    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header">
            <div class="d-flex justify-content-between">
                <div class="logo">
                    <a href="{{site_url()}}"><img src="{{assets_url('images/logo/logo.png')}}" alt="Logo" srcset=""></a>
                </div>
                <div class="toggler">
            ...
            <div class="card-body py-4 px-5">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-xl">
                        <img src="{{assets_url('images/faces/1.jpg')}}" alt="Face 1">
                    </div>
                    <div class="ms-3 name">
                        <h5 class="font-bold">{{auth()->getName()}}</h5>
                        <h6 class="text-muted mb-0">#{{auth()->getId()}}</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="sidebar-menu">
            <ul class="menu">
                <li class="sidebar-title">Menü {{getRoleName(auth()->getRole())}}{{auth()->getRole()}}</li>
                ...
                <div style="<?= (auth()->getRole() == 6) || (auth()->getRole() == 9) ? '' : 'display:none;'?>">
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('car')}}" class='sidebar-link'>
                ...
                <div style="<?= (auth()->getRole() == 8 ) || (auth()->getRole() == 7 ) ? 'display:none' : ''; ?>">
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('orders')}}" class='sidebar-link'>
                            <i class="bi bi-hdd-fill"></i>
                            <span>Servis Kayıtları</span>
                        </a>
                    </li>
                    <li class="sidebar-item  ">
                        <a href="{{site_url('orders/new-order')}}" class='sidebar-link'>
                            <i class="bi bi-hdd-fill"></i>
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('orders/list-orders')}}" class='sidebar-link'>
                ...
                <div style="<?= auth()->getRole() == 9 ? '' : 'display:none'?>">
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('user/settings')}}" class='sidebar-link'>
                ...
                <div style="<?= (auth()->getRole() == 9) || (auth()->getRole() == 8) ? '' : 'display:none' ?>">
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('store')}}" class='sidebar-link'>
                ...
                <div style="<?= auth()->getRole() == 9 ? '' : 'display:none' ?>">
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('department/settings')}}" class='sidebar-link'>
                            <i class="bi bi-gear-fill"></i>
                ...
                <div style="<?= (auth()->getRole() != 7 ) ? 'display:none' : ''; ?>">
                    ...
                    <li class="sidebar-item  ">
                        <a href="{{site_url('master/on-hold-order')}}" class='sidebar-link'>
                            <i class="bi bi-gear-fill"></i>
                            <span>Bekleyen İşler</span>
                        </a>
                    </li>
                    <li class="sidebar-item  ">
                        <a href="{{site_url('master/repair-order')}}" class='sidebar-link'>
                            <i class="bi bi-gear-fill"></i>
                            <span>Tamir Aşamasında Olan İşler</span>
                        </a>
                    </li>
                    <li class="sidebar-item  ">
                        <a href="{{site_url('master/complated-order')}}" class='sidebar-link'>
                            <i class="bi bi-gear-fill"></i>
                            <span>Tamamlanan İşler</span>
                        </a>
                    </li>
                    <li class="sidebar-item  ">
                        <a href="{{site_url('master/cancel-order')}}" class='sidebar-link'>
                            <i class="bi bi-gear-fill"></i>
